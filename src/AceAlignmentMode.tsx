...
(ace as IAceType).define("ace/mode/alignment_highlight_rules", function(
  require: Function,
  exports: any,
  module: any
) {
...
(ace as IAceType).define("ace/mode/alignment", function(
  require: Function,
  exports: any,
  module: any
) {
  ...
  var AlignmentHighlightRules = require("ace/mode/alignment_highlight_rules")
    .AlignmentHighlightRules;
